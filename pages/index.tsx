    ...
    return (
      <>
        {posts.map(({ n, fr, d, hp, dr, ATE, TTE, id }) => (
          <li
            className="grid grid-cols-2 text-sky-700 bg-sky-100 w-80 border rounded-md mt-2 mb-2"
            key={id}
          >
            <div>Name: {n}</div>
            <div></div>
      ...
      <main>
        ...
        <div className="flex min-w-screen items-center justify-center flex-col">
          <form>
            ...
            <p className="w-80 h-10 text-2xl ml-1 text-sky-300">
              Health-Points
            </p>
          ...
          */}
            ...
            <div>
              <button
                type="button"
                onClick={SaveForm}
                className="flex justify-center items-center w-80 h-12 border-sky-500 border rounded-md bg-sky-600 mb-5 text-3xl text-sky-100 active:bg-sky-500"
              >
                Save Item
              </button>
            </div>
